...
class ClusterSqliteImporter(common.AbstractAnalyser):
    ...
    def check_table(self):
        ...
        # create a table
        tb_create = "CREATE TABLE `" + self.table_name + "`(id int(15) NOT NULL AUTO_INCREMENT,cluster_id varchar(100) COLLATE utf8_bin NOT NULL,cluster_ratio float ,n_spec int(10) ,n_id int (10) ,n_unid int(10) ," + \
        ...
        tb_create_spec = "CREATE TABLE `" + self.table_name + "_spec` (id int(15) NOT NULL AUTO_INCREMENT,spectrum_title varchar(200) COLLATE utf8_bin NOT NULL,spec_prj_id varchar(10) COLLATE utf8_bin NOT NULL,charge float NOT NULL,precursor_mz float NOT NULL,taxids varchar(100) NOT NULL,is_spec_identified TINYINT(1) NOT NULL," + \
                         "id_sequences text NOT NULL,modifications varchar(500) NOT NULL,seq_ratio float NOT NULL,cluster_fk varchar(100) NOT NULL,PRIMARY KEY (id),INDEX(cluster_fk),CONSTRAINT FK_" + self.table_name + "_cluster_spec FOREIGN KEY (cluster_fk) REFERENCES `" + self.table_name + "`(cluster_id)" + \
